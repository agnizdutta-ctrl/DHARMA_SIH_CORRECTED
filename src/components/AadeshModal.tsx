...
const CATEGORIES = [
  {
    ...
    desc: 'Epic Sovereigns & Legendary Heroes (8 pts)'
  },
  {
    id: 'L' as const,
    name: 'Dharma (L)',
    ...
    desc: 'Righteous Counsel, Vows & Moral Principles (6 pts)'
  },
  {
    id: 'M' as const,
    name: 'Marvel (M)',
    ...
    desc: 'Divine Astras, Sacred Vessels & Wonders (4 pts)'
  },
  {
    id: 'R' as const,
    name: 'Region (R)',
    ...
    desc: 'Sacred Realms, Capitals & Epic Lands (2 pts)'
  }
];
