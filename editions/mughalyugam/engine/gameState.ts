...
export class GameRoom {
  ...
  constructor(id: string, maxRounds: number = 7) {
    this.id = id;
  ...
  buildDeck(): void {
    ...
    for (const ruler of cardsData.rulers) {
    ...
    for (const special of cardsData.specialCards) {
  ...
  dealCards(): void {
    ...
    const handSize = cardsData.config.handSize || 5;
